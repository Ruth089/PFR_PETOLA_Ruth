...
class Inscription  extends Component {
  ...
  validate = () => {
    ...
    if (!this.state.pseudonom) {
      nomsError = "pseudonom incorrect!";
    }
    if (!this.state.pwd) {
  ...
  CreateUser = (event) => {
    ...
    let user = {
      ...
      pseudonom :this.state.pseudonom,
      pwd: this.state.pwd
    };
    ...
    .catch((err) => {
      ...
      alert("echec")
      this.setState({ loader: "", nom: "", pwd: "", prenom : "", pseudonom:"",  })
    });
              ...
              <div className="ui stacked secondary">
                  ...
                  <div className="field">
                    ...
                    <input
                        type="text"
                        name="pseudonom"
                        placeholder="pseudonom"
                        value={this.state.pseudonom}
                        onChange={this.handleChange}
                      />
                    </div>
                    <div style={{ color: "red" }}>{this.state.nomsError}</div>
